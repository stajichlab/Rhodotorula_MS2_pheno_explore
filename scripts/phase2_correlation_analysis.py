...
# Stage 2: Across-phenotype Benjamini-Hochberg FDR correction
print(f"\n  Applying across-phenotype Benjamini-Hochberg FDR correction")
reject_global, q_values_global, _, _ = multipletests(df_results['q_value_stage1'], method='fdr_bh', alpha=0.05)
df_results['q_value_global'] = q_values_global
df_results['reject_global'] = reject_global
